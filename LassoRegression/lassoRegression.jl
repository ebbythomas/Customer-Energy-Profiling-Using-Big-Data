...
cd(raw"H:/bigDataPaper/Sep5Codes/LassoRegression")


myTrain = CSV.read("../DataProcessing/myTrainSet.csv");
myValid = CSV.read("../DataProcessing/myValidSet.csv");
myTest = CSV.read("../DataProcessing/myTestSet.csv");
